...
<table class="table  listview-table  floatThead-table">
	...
	{php}exit();{/php}*}
			...
			<td><button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target=".mt4_report_pop">Matta</button></td>
		</tr>
	{/foreach}
...
<div class="modal fade mt4_report_pop" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
