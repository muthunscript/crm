...
//			});
	...
	openPopUp : function(e) {
		...
		console.log("openPopUp......"+jQuery('[name="returnrecord"]').val());
		...
		params.view = 'Popup';
		/**********/
		params.returnrecord = jQuery('[name="returnrecord"]').val();
		/**********/
...
//					
	...
	getPopUpParams : function(container) {
		...
		var returnRecordElement = jQuery('input[name="returnrecord"]');
		var returnRecordId = '';
		var recordId = app.getRecordId();
		if(returnRecordElement.length > 0) {
			returnRecordId = returnRecordElement.val();
		} else if(recordId) {
			returnRecordId = recordId;
		} else if(app.view() == 'List') {
			var editRecordId = jQuery('#listview-table').find('tr.listViewEntries.edited').data('id');
			if(editRecordId) {
				returnRecordId = editRecordId;
			}
		}

		if(searchResultContainer.length) {
			returnRecordId = searchResultContainer.find('tr.listViewEntries.edited').data('id')
		}
		
		
		console.log("returnRecordId..."+returnRecordId);
...
function call_onchange(){
		
		console.log("leadstatus onchange...........");
		
	}
	$("select[name='leadstatus']").change(call_onchange);