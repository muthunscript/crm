...
{strip}
	{assign var=RELATED_MODULE_NAME value=$RELATED_MODULE->get('name')}
	 ...
	 {*{php}
	 echo "lllllll";
	$total = $this->_tpl_vars['RELATED_MODULE_NAME'];
   ...
   {/php}*}
	 ...
	 {*{php}
	 echo "kljklj";
   echo var_dump($RELATED_MODULE->get('name'));
   exit();
   {/php}*}
	...
	<div class="relatedContainer">
		...
		{*{$MODULE|print_r}Contacts1mt4account1
		{$RELATED_MODULE_NAME|print_r}
					...
					{foreach item=RELATED_RECORD from=$RELATED_RECORDS}
						<tr class="listViewEntries" data-id='{$RELATED_RECORD->getId()}' 
							...
							{if $MODULE eq 'Contacts' && $RELATED_MODULE_NAME eq 'mt4account'}
								...
								<td><a href="http://20.0.0.2/vtigercrm/index.php?module=deposit&view=Edit&__vtrftk=sid%3A878dcebdb8624762a265ec5d8313b1f636e3d8f3%2C1580204992&loginid=&currency_code=&card_no=&amount=&gateway=&status=&datetime=&sourceModule=Contacts&sourceRecord=315&relationOperation=true&returnmode=showRelatedList&returntab_label=Deposit&returnrecord=315&returnmodule=Contacts&returnview=Detail&returnrelatedModuleName=deposit&returnrelationId=174&app=MARKETING"><span class="fa fa-upload" style="display:flex;background-color:#70ca63;width: 38px; color: #fff; height: 28px; align-items: center;justify-content:center; font-size: 13px"></span></a></td>
								
								
								<td><a href="http://20.0.0.2/vtigercrm/index.php?module=withdraw&view=Edit&__vtrftk=sid%3A11c92ecf7b7cb6af6189ff97e72651b39fc926fe%2C1580205044&loginid=&name=&bank_name=&popupReferenceModule=mt4account&login_id=&login_id_display=&sort_code=&iban=&swift=&bank_acc_id=&amount=&datetime=&status=&sourceModule=Contacts&sourceRecord=315&relationOperation=true&returnmode=showRelatedList&returntab_label=Withdraw&returnrecord=315&returnmodule=Contacts&returnview=Detail&returnrelatedModuleName=withdraw&returnrelationId=173&app=MARKETING"><span class="fa fa-download" style="display:flex;background-color:#27a0cc;width: 38px; color: #fff; height: 28px; align-items: center;justify-content:center; font-size: 13px"></span></a></td>
								
								
								<td><a href="http://20.0.0.2/vtigercrm/index.php?module=livechat&view=List&app=SUPPORT&test=1&testmodule=mt4chart"><span class="fa fa-file" style="display:flex;background-color:#f8b93b;width: 38px; color: #fff; height: 28px; align-items: center;justify-content:center; font-size: 13px"></span></a> </td>
