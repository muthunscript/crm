...
<div class="app-menu hide" id="app-menu">
	<div class="container-fluid">
		...
		<div class="app-list row">
			...
			<div class="menu-item app-item dropdown-toggle app-item-color-{$APP_NAME}" data-app-name="{$APP_NAME}" id="{$APP_NAME}_modules_dropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" data-default-url="index.php?module=mt4report&view=List&app=SUPPORT&offers=1">
				<div class="menu-items-wrapper app-menu-items-wrapper">
