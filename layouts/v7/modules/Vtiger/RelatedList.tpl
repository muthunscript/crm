				...
				<table id="listview-table" class="table listview-table">
					<thead>
						<tr class="listViewHeaders">
							...
							{if $MODULE eq 'Contacts' && $RELATED_MODULE_NAME eq 'mt4account'}
								<th>Trade</th>
								<th>Deposit</th>
								<th>Withdraw</th>
								<th>Report</th>
					...
					{foreach item=RELATED_RECORD from=$RELATED_RECORDS}
						<tr class="listViewEntries" data-id='{$RELATED_RECORD->getId()}' 
									...
									<span class="value textOverflowEllipsis">
										{if $RELATED_MODULE_NAME eq 'Documents' && $RELATED_HEADERNAME eq 'document_source'}
											...
											{else}
												...
												{assign var=foo value="{$RELATED_RECORD->getDisplayValue($RELATED_HEADERNAME)}" scope="global"}
							...
							<!--order-->
							<td>
							<!--<button type="button" module="mt4trade" class="btn btn-default addButton" name="addButton" data-url="index.php?module=mt4trade&amp;view=Edit&amp;returnmode=showRelatedList&amp;returntab_label=mt4trade&amp;returnrecord={$PARENT_ID}&amp;returnmodule=Contacts&amp;returnview=Detail&amp;returnrelatedModuleName=mt4trade&amp;returnrelationId=179&amp;app=MARKETING">Edit Trade</button>
							-->

							<a href="index.php?module=mt4trade&view=List&viewname=69&app=MARKETING&loginid={$foo}&loginid_details=1" target="_blank"><button type="button">Edit Trade</button></a>
