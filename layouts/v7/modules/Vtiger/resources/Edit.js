...
Vtiger_Index_Js("Vtiger_Edit_Js",{
    ...
    */
    ...
    registerEvents: function(callParent) {
		...
		/*********/
		var close_order=false;
		var field = 'close_order';
		...
		container.find('[name="login"]').parent('td').css('pointer-events', 'none');
		container.find('[name="login"]').css('background-color' , '#DEDEDE');
		container.find('[name="loginid"]').parent('td').css('pointer-events', 'none');
		container.find('[name="loginid"]').css('background-color' , '#DEDEDE');
		...
		*/
		...
		if(close_order)
		{
			container.find('[name="symbol"]').parent('td').parent('tr').show();
			container.find('[name="comment"]').parent('td').parent('tr').show();
			container.find('[name="symbol"]').parent('td').css('pointer-events', 'none');
			container.find('[name="symbol"]').css('background-color' , '#DEDEDE');
