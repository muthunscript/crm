...
Vtiger.Class("Vtiger_List_Js", {
	listInstance: false,
	filterClick: false,
	phoneNumberAlert: function(){
		localStorage.setItem('currentElement', 'phone');
		console.log(app);
		//Vtiger_Helper_Js.showPnotify(app.vtranslate('JS_MASS_EDIT_LIMIT'));
		app.helper.showAlertBox({message: 'Intergrate link your VOIP account.'});
//		alert('Test Message');
	},
				...
				setTimeout(function () {
					...
					if (editedLength === 0) {
						...
						if (selection.length == 0) {
							...
							if(!localStorage.getItem('currentElement') || localStorage.getItem('currentElement') == ''){
