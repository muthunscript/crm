...
{
	global $root_directory, $root_directory1;
	$handle=@fopen($root_directory1.'user_privileges/user_privileges_'.$userid.'.php',"w+");
...
{
	//echo "createUserSharingPrivilegesfile";
	//exit();
	
	global $adb, $root_directory, $root_directory1;
	
	//echo 'user_privileges/user_privileges_'.$userid.'.php';
	//exit();
	
	checkFileAccessForInclusion('user_privileges/user_privileges_'.$userid.'.php');
	require('user_privileges/user_privileges_'.$userid.'.php');
	$handle=@fopen($root_directory1.'user_privileges/sharing_privileges_'.$userid.'.php',"w+");
