...
class riskintelligence extends CRMEntity {
	var $log;
	var $db;

	var $table_name = "vtiger_riskintelligence";
	var $table_index= 'riskintelligenceid';
	var $tab_name = Array('vtiger_crmentity','vtiger_riskintelligence');
	var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_riskintelligence'=>'riskintelligenceid');
	/**
	...
	'Chat ID' => Array('riskintelligence'=>'chatid'),
	'User' => Array('riskintelligence'=>'userid'),
	'Agent' => Array('riskintelligence'=>'agentid'),
	);
	...
	function riskintelligence() {
		$this->log = LoggerManager::getLogger('riskintelligence');
		$this->db = PearDatabase::getInstance();
		
		//$this->db->setDebug(true);
		
		$this->column_fields = getColumnFields('riskintelligence');
	}
