...
class mt4report extends CRMEntity {
	var $log;
	var $db;

	var $table_name = "vtiger_mt4report";
	var $table_index= 'mt4reportid';
	var $tab_name = Array('vtiger_crmentity','vtiger_mt4report');
	var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_mt4report'=>'mt4reportid');
	/**
	...
	'Chat ID' => Array('mt4report'=>'chatid'),
	'User' => Array('mt4report'=>'userid'),
	'Agent' => Array('mt4report'=>'agentid'),
	);
	...
	function mt4report() {
		$this->log = LoggerManager::getLogger('mt4report');
		$this->db = PearDatabase::getInstance();
		
		//$this->db->setDebug(true);
		
		$this->column_fields = getColumnFields('mt4report');
	}
