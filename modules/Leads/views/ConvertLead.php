...
class Leads_ConvertLead_View extends Vtiger_Index_View {
	...
	function process(Vtiger_Request $request) {
		...
		$assignedToFieldModel = $moduleModel->getField('accountnew_id');
		$assignedToFieldModel->set('fieldvalue', $recordModel->get('accountnew_id'));
		$viewer->assign('accountnew', $assignedToFieldModel);
