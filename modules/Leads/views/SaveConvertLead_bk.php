...
class Leads_SaveConvertLead_View extends Vtiger_View_Controller {
	...
	public function process(Vtiger_Request $request) {
		...
		//echo "Leads_SaveConvertLead_View";
		//exit();
		...
		//$accountnewId = $request->get('accountnew_id');
	...
	//$entityValues['accountnewId'] =  vtws_getWebserviceEntityId($request->getModule(), $accountnewId);
