...
class Settings_Profiles_Record_Model extends Settings_Vtiger_Record_Model {
	...
	public function save() {
		...
		global $log;
		$log->info("save profile_permissions.........la");
		...
		if($moduleModel->isEntityModule() || $moduleModel->isUtilityActionEnabled()) {
			if($actionPermissions || $moduleModel->isUtilityActionEnabled()) {
				...
				if ($profileActionPermissions) {
					...
					$log->info("Standard permissions......");
					
					//echo var_dump($actionsIdsList);
					//exit();
					...
					if ($actionsIdsList) {
						...
						$log->info("vtiger_profile2standardpermissions...........");
						$log->info($actionsInsertQuery);
						$log->info($params);
					...
					if ($utilityIdsList) {
						...
						//echo var_dump($utilityInsertQuery);
						//exit();
