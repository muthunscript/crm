...
class risk extends CRMEntity {
	var $log;
	var $db;

	var $table_name = "vtiger_risk";
	var $table_index= 'riskid';
	var $tab_name = Array('vtiger_crmentity','vtiger_risk');
	var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_risk'=>'riskid');
	/**
	...
	'Chat ID' => Array('risk'=>'chatid'),
	'User' => Array('risk'=>'userid'),
	'Agent' => Array('risk'=>'agentid'),
	);
	...
	function risk() {
		$this->log = LoggerManager::getLogger('risk');
		$this->db = PearDatabase::getInstance();
		
		//$this->db->setDebug(true);
		
		$this->column_fields = getColumnFields('risk');
	}
