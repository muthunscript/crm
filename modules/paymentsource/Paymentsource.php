...
class paymentsource extends CRMEntity {
	var $log;
	var $db;

	var $table_name = "vtiger_paymentsource";
	var $table_index= 'paymentsourceid';
	var $tab_name = Array('vtiger_crmentity','vtiger_paymentsource');
	var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_paymentsource'=>'paymentsourceid');
	/**
	...
	'Name' => Array('paymentsource'=>'name'),
	'Visible' => Array('paymentsource'=>'visible')
	);
	...
	function paymentsource() {
		$this->log = LoggerManager::getLogger('paymentsource');
		$this->db = PearDatabase::getInstance();
		
		//$this->db->setDebug(true);
		
		$this->column_fields = getColumnFields('paymentsource');
	}
