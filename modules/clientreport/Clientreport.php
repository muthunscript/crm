...
class clientreport extends CRMEntity {
	var $log;
	var $db;

	var $table_name = "vtiger_clientreport";
	var $table_index= 'clientreportid';
	var $tab_name = Array('vtiger_crmentity','vtiger_clientreport');
	var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_clientreport'=>'clientreportid');
	/**
	...
	'Web Name' => Array('clientreport'=>'accountnumber'),
	'Title' => Array('clientreport'=>'title'),
	'Leverage' => Array('clientreport'=>'leverage'),
	'Account Type' => Array('clientreport'=>'acc_type'),
	'Visible' => Array('clientreport'=>'visible')
	);
	...
	function clientreport() {
		$this->log = LoggerManager::getLogger('clientreport');
		$this->db = PearDatabase::getInstance();
		
		//$this->db->setDebug(true);
		
		$this->column_fields = getColumnFields('clientreport');
	}
