...
class riskinstruments extends CRMEntity {
	var $log;
	var $db;

	var $table_name = "vtiger_riskinstruments";
	var $table_index= 'riskinstrumentsid';
	var $tab_name = Array('vtiger_crmentity','vtiger_riskinstruments');
	var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_riskinstruments'=>'riskinstrumentsid');
	/**
	...
	'Chat ID' => Array('riskinstruments'=>'chatid'),
	'User' => Array('riskinstruments'=>'userid'),
	'Agent' => Array('riskinstruments'=>'agentid'),
	);
	...
	function riskinstruments() {
		$this->log = LoggerManager::getLogger('riskinstruments');
		$this->db = PearDatabase::getInstance();
		
		//$this->db->setDebug(true);
		
		$this->column_fields = getColumnFields('riskinstruments');
	}
