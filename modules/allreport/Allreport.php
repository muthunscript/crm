...
class allreport extends CRMEntity {
	var $log;
	var $db;

	var $table_name = "vtiger_allreport";
	var $table_index= 'allreportid';
	var $tab_name = Array('vtiger_crmentity','vtiger_allreport');
	var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_allreport'=>'allreportid');
	/**
	...
	'Chat ID' => Array('allreport'=>'chatid'),
	'User' => Array('allreport'=>'userid'),
	'Agent' => Array('allreport'=>'agentid'),
	);
	...
	function allreport() {
		$this->log = LoggerManager::getLogger('allreport');
		$this->db = PearDatabase::getInstance();
		
		//$this->db->setDebug(true);
		
		$this->column_fields = getColumnFields('allreport');
	}
