...
class livechat extends CRMEntity {
	var $log;
	var $db;

	var $table_name = "vtiger_livechat";
	var $table_index= 'livechatid';
	var $tab_name = Array('vtiger_crmentity','vtiger_livechat');
	var $tab_name_index = Array('vtiger_crmentity'=>'crmid','vtiger_livechat'=>'livechatid');
	/**
	...
	'Chat ID' => Array('livechat'=>'chatid'),
	'User' => Array('livechat'=>'userid'),
	'Agent' => Array('livechat'=>'agentid'),
	);
	...
	function livechat() {
		$this->log = LoggerManager::getLogger('livechat');
		$this->db = PearDatabase::getInstance();
		
		//$this->db->setDebug(true);
		
		$this->column_fields = getColumnFields('livechat');
	}
