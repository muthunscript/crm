...
class WebserviceField{
	...
	public function getReferenceList($hideDisabledModules = true){
		...
		//echo var_dump($this->uitype);
		//echo var_dump($this->fieldLabel);
		
		/*
		if($this->uitype==552 || $this->uitype==52)
		{
			echo var_dump($this->getUIType());
			echo var_dump($this->genericUIType);
			exit();
		}
		*/
		...
		if($this->referenceList === null){
			...
			*/
            ...
            if($hideDisabledModules) {
				...
				/*
				if($this->uitype==552 || $this->fieldLabel=="Account Name")
				{
					echo var_dump($referenceTypes);
					echo var_dump($accessibleTypes);
					exit();
				}
				*/
		...
		//if($this->uitype==552 || $this->fieldLabel=="Account Name")//$this->uitype==52 || 
		//	{
				/*echo var_dump($this->getFieldId);
				echo var_dump($fieldTypeData['fieldtypeid']);
				echo var_dump($sql);
				...
				//echo var_dump($this->referenceList);
