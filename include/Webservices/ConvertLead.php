...
function vtws_convertlead($entityvalues, $user) {
	...
	try {
		...
		vtws_updateConvertLeadStatus($entityIds, $entityvalues['leadId'], $entityvalues['accountnewId'], $user);
		...
		/********Mt4 account start*******/
				...
				$accountnewIdComponents = vtws_getIdComponents($entityvalues['accountnewId']);
