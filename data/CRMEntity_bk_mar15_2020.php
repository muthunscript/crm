		...
		//$contactId = $con_id;
			...
			if($deposit_id!="" && $deposit_id!=0)
			{
				...
				*/
				...
				$log->info("credit_points entity".$credit_points);
				...
				if($credit_points>0)
				{
					...
					{
						$adb->pquery('UPDATE vtiger_deposit SET credits_status=2,credits='.$credit_points.' WHERE `depositid`= ?',array($deposit_id));
					}
				}
