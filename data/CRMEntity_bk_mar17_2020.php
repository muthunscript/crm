	...
	function insertIntoEntityTable($table_name, $module, $fileid = '') {
		...
		if ($insertion_mode == 'edit') {
			...
			/*	
				...
				else if(isset($_REQUEST["open_order"])&&$_REQUEST["open_order"]==1&&$table_name=="vtiger_mt4trade")
				{
					//echo "open_order......";
				}
			
				if($_REQUEST["loginid_details"]==1)
				{
			...
			//	exit();
				...
				if (count($update) > 0) {
					...
					if($table_name=="vtiger_mt4trade")
					{
						...
						//order_edit_delete($login,$deal,$openprice,$closeprice,$profit,$sl,$tp,$mode);
