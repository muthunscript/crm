...
class CRMEntity {
	...
	function saveentity($module, $fileid = '') {
		...
		global $current_user, $adb,$log,$con_id,$mode_c; //$adb added by raju for mass mailing
	...
	function insertIntoEntityTable($table_name, $module, $fileid = '') {
		...
		/*
				...
				if($module == "Contacts" && $table_name == "vtiger_contactscf")//vtiger_contactdetails
				{
					$contactId=$value[0];
					$log->info("vtiger_mt4account enter");		
					...
					$lead_data = $adb->pquery($lead_data, array($contactId));
					$lead_data=$adb->fetch_array($lead_data);
				...
				$params2 = array($current_id, $login_id, '1', '1', $passsword, $investor_pwd, $accountnewIdComponents[1],'100','Live');
				$adb->pquery($sql2, $params2);
				...
				//$params3 = array($leadId, 'Leads', $current_id, 'mt4account');
				$params3 = array($contactId, 'Contacts', $current_id, 'mt4account');
				$adb->pquery($sql3, $params3);
