<?php /* Smarty version Smarty-3.1.7, created on 2020-03-27 16:58:45
         compiled from "C:\xampp\htdocs\vtigercrm\crm\includes\runtime/../../layouts/v7\modules\Vtiger\ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13904673305e7de36d052ea7-70410718%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b339ed54c5bc332fbca3cb289c4ddad71efd6d1a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtigercrm\\crm\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\ListViewContents.tpl',
      1 => 1585299354,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13904673305e7de36d052ea7-70410718',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e7de36d1ac0f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e7de36d1ac0f')) {function content_5e7de36d1ac0f($_smarty_tpl) {?>
...
<?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='livechat'){?>
...
?>
						...
						<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='deposit'){?>
...
"<?php }?> > 
										...
										<?php }else{ ?>
											...
											<?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')=='phone'&&$_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value!=''){?>
					...
					<?php if ($_smarty_tpl->tpl_vars['CREDIT']->value==1){?>
					
                     <td class="acceptt"><a href="deposit_credit.php?depositid=<?php echo $_smarty_tpl->tpl_vars['DATA_ID']->value;?>
&type=1&current_url=<?php echo $_smarty_tpl->tpl_vars['ACTUAL_LINK']->value;?>
"><button> Approve </button></a></td>
                    <td class="acceptt declm"><a href="deposit_credit.php?depositid=<?php echo $_smarty_tpl->tpl_vars['DATA_ID']->value;?>
&type=2&current_url=<?php echo $_smarty_tpl->tpl_vars['ACTUAL_LINK']->value;?>
"><button> Decline </button></a></td>
					<?php }?>
					
					
					<?php if ($_smarty_tpl->tpl_vars['MODULE']->value=="deposit"&&$_smarty_tpl->tpl_vars['SETTINGS']->value["deposit"]==0){?>
						<?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getRaw("status")=='Pending'){?>
							 <td class="acceptt"><a href="deposit_request.php?depositid=<?php echo $_smarty_tpl->tpl_vars['DATA_ID']->value;?>
&type=1&current_url=<?php echo $_smarty_tpl->tpl_vars['ACTUAL_LINK']->value;?>
"><button> Approve </button></a></td>
							 <td class="acceptt declm"><a href="deposit_request.php?depositid=<?php echo $_smarty_tpl->tpl_vars['DATA_ID']->value;?>
&type=2&current_url=<?php echo $_smarty_tpl->tpl_vars['ACTUAL_LINK']->value;?>
"><button> Decline </button></a></td>
						<?php }else{ ?>
							<td></td>
							<td></td>
						<?php }?>
					<?php }elseif($_smarty_tpl->tpl_vars['MODULE']->value=="withdraw"&&$_smarty_tpl->tpl_vars['SETTINGS']->value["withdraw"]==0){?>
						<?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getRaw("status")=='Pending'){?>
							 <td class="acceptt"><a href="withdraw_request.php?withdrawid=<?php echo $_smarty_tpl->tpl_vars['DATA_ID']->value;?>
&type=1&current_url=<?php echo $_smarty_tpl->tpl_vars['ACTUAL_LINK']->value;?>
"><button> Approve </button></a></td>
							<td class="acceptt declm"><a href="withdraw_request.php?withdrawid=<?php echo $_smarty_tpl->tpl_vars['DATA_ID']->value;?>
&type=2&current_url=<?php echo $_smarty_tpl->tpl_vars['ACTUAL_LINK']->value;?>
"><button> Decline </button></a></td>
						<?php }else{ ?>
							<td></td>
