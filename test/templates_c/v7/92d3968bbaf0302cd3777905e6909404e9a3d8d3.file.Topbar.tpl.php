<?php /* Smarty version Smarty-3.1.7, created on 2020-04-17 16:48:29
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Vtiger\partials\Topbar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13594456355e999085088167-39281235%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '92d3968bbaf0302cd3777905e6909404e9a3d8d3' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\partials\\Topbar.tpl',
      1 => 1587119365,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13594456355e999085088167-39281235',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e99908511131',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e99908511131')) {function content_5e99908511131($_smarty_tpl) {?>
...
</a></li></ul></div><?php }else{ ?><?php $_smarty_tpl->tpl_vars['custommodelid'] = new Smarty_variable(vtranslate($_smarty_tpl->tpl_vars['moduleModel']->value->get('id'),$_smarty_tpl->tpl_vars['moduleName']->value), null, 0);?><div class="<?php if ($_smarty_tpl->tpl_vars['hideDiv']->value){?>create_restricted_<?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getName();?>
 hide<?php }else{ ?>col-lg-4<?php }?>"><a id="menubar_quickCreate_<?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getName();?>
" class="quickCreateModule <?php if ($_smarty_tpl->tpl_vars['custommodelid']->value>52||$_smarty_tpl->tpl_vars['custommodelid']->value==27){?>custom-icon-container<?php }?> <?php echo $_smarty_tpl->tpl_vars['custommodelid']->value;?>
