<?php /* Smarty version Smarty-3.1.7, created on 2020-03-31 19:40:20
         compiled from "C:\xampp\htdocs\vtigercrm\crm\includes\runtime/../../layouts/v7\modules\mt4report\ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12512483605e830458be0c12-02696813%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '705a4fec12eea51869860febfe9cf6b51691e872' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtigercrm\\crm\\includes\\runtime/../../layouts/v7\\modules\\mt4report\\ListViewContents.tpl',
      1 => 1585663182,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12512483605e830458be0c12-02696813',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5e83045930741',
  'variables' => 
  array (
    'MODULE' => 0,
    'RISK' => 0,
    'IBMANAGEMENT' => 0,
    'MANAGENOTIFICATION' => 0,
    'ACTUAL_LINK' => 0,
    'SETTINGS' => 0,
    'DEPOSIT_DATA' => 0,
    'WITHDRAW_DATA' => 0,
...
<?php if ($_valid && !is_callable('content_5e83045930741')) {function content_5e83045930741($_smarty_tpl) {?>
...
<?php }elseif($_smarty_tpl->tpl_vars['MANAGENOTIFICATION']->value=='1'){?>
<form name="managenotification" action="manage_notification.php" method="POST" id="managenotification">
	<input type="hidden" name="module" value="managenotification" />
	<div name="editContent" style="margin: 20px 20px;">
		<div class="fieldBlockContainer" data-block="LBL_MANAGENOTIFICATION_DETAILS">
			<h4 class="fieldBlockHeader">Manage Notifications</h4>
			<hr>
			<table class="table table-borderless">
				<tbody>
					<tr>
						<td style="width: 20%;" class="fieldLabel alignMiddle">All Users&nbsp;</td>
						<td style="width: 25%;" class="fieldValue" >
							<input type="hidden" name="allusers" value="0">
							<input id="managenotification_editView_fieldName_allusers" class="inputElement" style="width:15px;height:15px;" data-fieldname="allusers" data-fieldtype="checkbox" type="checkbox" name="allusers">
						</td>
						<td style="width:20%;" class="fieldLabel alignMiddle">Users&nbsp;</td>
						<td>
					...
					<tr>
						<td style="width: 20%;" class="fieldLabel alignMiddle">All modules&nbsp;</td>
						<td style="width: 25%;" class="fieldValue" >
							<input type="hidden" name="allmodules" value="0">
							<input id="managenotification_editView_fieldName_allmodules" class="inputElement" style="width:15px;height:15px;" data-fieldname="allmodules" data-fieldtype="checkbox" type="checkbox" name="allmodules">
						</td>
						<td style="width: 20%;" class="fieldLabel alignMiddle">Modules&nbsp;</td>
						<td >
