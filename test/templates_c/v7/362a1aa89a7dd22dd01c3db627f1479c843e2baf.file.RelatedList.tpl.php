<?php /* Smarty version Smarty-3.1.7, created on 2020-03-15 11:49:07
         compiled from "C:\xampp\htdocs\vtigercrm\includes\runtime/../../layouts/v7\modules\Vtiger\RelatedList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:175565df09ffded01e2-20166518%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '175565df09ffded01e2-20166518',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5df09ffe2d642',
  'variables' => 
  array (
    'RELATED_MODULE' => 0,
    'MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_5df09ffe2d642')) {function content_5df09ffe2d642($_smarty_tpl) {?>
...
"><?php }?>&nbsp;</a><?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value==$_smarty_tpl->tpl_vars['HEADER_FIELD']->value->get('column')){?><a href="#" class="removeSorting"><i class="fa fa-remove"></i></a><?php }?><?php }?><?php }?></th><?php } ?><!--start--><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Contacts'&&$_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value=='mt4account'){?><th>Trade</th><th>Deposit</th><th>Withdraw</th><th>Report</th><?php }?><!--end--></tr><tr class="searchRow"><th class="inline-search-btn"><button class="btn btn-success btn-sm" data-trigger="relatedListSearch"><?php echo vtranslate("LBL_SEARCH",$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</a><?php $_smarty_tpl->tpl_vars['foo'] = new Smarty_variable(($_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getDisplayValue($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value)), null, 3);
$_ptr = $_smarty_tpl->parent; while ($_ptr != null) {$_ptr->tpl_vars['foo'] = clone $_smarty_tpl->tpl_vars['foo']; $_ptr = $_ptr->parent; }
Smarty::$global_tpl_vars['foo'] = clone $_smarty_tpl->tpl_vars['foo'];?><?php }elseif($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value=='access_count'){?><?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getAccessCountValue($_smarty_tpl->tpl_vars['PARENT_RECORD']->value->getId());?>
...
" class="icon-download-alt alignMiddle"></i></a>&nbsp;<?php }?></span><?php }?><?php }?><?php }?></span></td><?php } ?><!--start--><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Contacts'&&$_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value=='mt4account'){?><!--order--><td><!--<button type="button" module="mt4trade" class="btn btn-default addButton" name="addButton" data-url="index.php?module=mt4trade&amp;view=Edit&amp;returnmode=showRelatedList&amp;returntab_label=mt4trade&amp;returnrecord=<?php echo $_smarty_tpl->tpl_vars['PARENT_ID']->value;?>
&amp;returnmodule=Contacts&amp;returnview=Detail&amp;returnrelatedModuleName=mt4trade&amp;returnrelationId=179&amp;app=MARKETING">Edit Trade</button>--><a href="index.php?module=mt4trade&view=List&viewname=69&app=MARKETING&loginid=<?php echo $_smarty_tpl->tpl_vars['foo']->value;?>
&loginid_details=1" target="_blank"><button type="button">Edit Trade</button></a></td><!--deposit--><td><button type="button" module="deposit" class="btn btn-default addButton" name="addButton" data-url="index.php?module=deposit&amp;view=Edit&amp;returnmode=showRelatedList&amp;returntab_label=Deposit&amp;returnrecord=<?php echo $_smarty_tpl->tpl_vars['PARENT_ID']->value;?>
&amp;returnmodule=Contacts&amp;returnview=Detail&amp;returnrelatedModuleName=deposit&amp;returnrelationId=174&amp;app=MARKETING"><span class="fa fa-upload" style="display:flex;background-color:#70ca63;width: 38px; color: #fff; height: 28px; align-items: center;justify-content:center; font-size: 13px"></span></button></td><!--withdraw--><td><button type="button" module="withdraw" class="btn btn-default addButton" name="addButton" data-url="index.php?module=withdraw&amp;view=Edit&amp;returnmode=showRelatedList&amp;returntab_label=Withdraw&amp;returnrecord=<?php echo $_smarty_tpl->tpl_vars['PARENT_ID']->value;?>
&amp;returnmodule=Contacts&amp;returnview=Detail&amp;returnrelatedModuleName=withdraw&amp;returnrelationId=173&amp;app=MARKETING"><span class="fa fa-download" style="display:flex;background-color:#27a0cc;width: 38px; color: #fff; height: 28px; align-items: center;justify-content:center; font-size: 13px"></span></button></td><!--report--><td><a href="index.php?module=mt4report&view=List&app=SUPPORT&loginid=<?php echo $_smarty_tpl->tpl_vars['foo']->value;?>
"><span class="fa fa-file" style="display:flex;background-color:#f8b93b;width: 38px; color: #fff; height: 28px; align-items: center;justify-content:center; font-size: 13px"></span></a> </td><?php }?><!--end--></tr><?php } ?></table></div></div><script type="text/javascript">var related_uimeta = (function () {var fieldInfo = <?php echo $_smarty_tpl->tpl_vars['RELATED_FIELDS_INFO']->value;?>
